...
import (
	...
	hello_world "git.company.com/examples/hello-world/service-go/internal/hello-world-server"
)
...
func Run(cfg nserver.Config) {
	...
	hello_world.RegisterService(cfg, r, s)
	...
	// Run!
	logs.Info("hello_world.Unified.Server", " started.")
	logs.Info("hello_world.Unified.Server", <-errc)
	logs.Info("hello_world.Unified.Server", " closed.")
}
