...
func (e Endpoints) GetUserinfo(ctx context.Context, in *pb.GetUserinfoRequest) (*pb.Userinfo, error) {
...
func MakeGetUserinfoEndpoint(s pb.UserServer) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (response interface{}, err error) {
		req := request.(*pb.GetUserinfoRequest)
...
func (e *Endpoints) WrapAllLabeledExcept(middleware func(string, endpoint.Endpoint) endpoint.Endpoint, excluded ...string) {
	...
	for inc, _ := range included {
		if inc == "get_userinfo" {
			e.GetUserinfoEndpoint = middleware("get_userinfo", e.GetUserinfoEndpoint)
		}
	}
}
