...
import (
	...
	user "github.com/liankui/prenatal-server/service-go/internal/user-server"
)
...
func Run(cfg nserver.Config) {
	...
	// Run!
	logs.Info("user.Unified.Server", " started.")
	logs.Info("user.Unified.Server", <-errc)
	logs.Info("user.Unified.Server", " closed.")
}
