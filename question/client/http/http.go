...
import (
	...
	endpoint1 "github.com/liankui/prenatal-server/question/pkg/endpoint"
	http2 "github.com/liankui/prenatal-server/question/pkg/http"
...
func New(instance string, options map[string][]http.ClientOption) (service.QuestionService, error) {
