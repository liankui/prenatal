...
import (
	...
	endpoint "github.com/liankui/prenatal-server/question/pkg/endpoint"
	http1 "github.com/liankui/prenatal-server/question/pkg/http"
	service "github.com/liankui/prenatal-server/question/pkg/service"
...
var fs = flag.NewFlagSet("question", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("question", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
